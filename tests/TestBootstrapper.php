...
class TestBootstrapper
{
    ...
    public function addCallingPlugin(?string $pathToComposerJson = null): TestBootstrapper
    {
        ...
        if (!is_array($composer)) throw new \RuntimeException('composer.json does not exists or is malformed');
    ...
    private function dbExists(): bool
    {
        try {
            ...
            if (!$connection) throw new \RuntimeException("Missing connection configuration");
